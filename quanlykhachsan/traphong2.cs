...
namespace quanlykhachsan
{
    public partial class traphong2 : Form
    {
        ...
        private void ketnoi1()
        {
            try
            {
                SqlConnection kn1 = new SqlConnection(@"Data Source=LAPTOP-T06NA3IS\SQLEXPRESS;Initial Catalog=QLKhachSan;Integrated Security=True");
                kn1.Open();
        ...
        private void dgvthuephong_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlConnection kn = new SqlConnection(@"Data Source=LAPTOP-T06NA3IS\SQLEXPRESS;Initial Catalog=QLKhachSan;Integrated Security=True");
                kn.Open();
                tt = @"SELECT GIAPHONG
...
WHERE (tbl_phieuthuephong.MAPHIEUTHUE=N'" + txtMaphieu.Text + @"')";
        ...
        public void ketnoi()
        {
            try
            {
                if (cn.State == 0)
                {
                    cn.ConnectionString = @"Data Source=LAPTOP-T06NA3IS\SQLEXPRESS;Initial Catalog=QLKhachSan;Integrated Security=True";
                    cn.Open();
                }
            }
            catch (Exception ex)
        ...
        private void traphong2_Load(object sender, EventArgs e)
        {
            ...
            //this.tbl_phongTableAdapter.Fill(this.quanlykhachsanDataSet.tbl_phong);
            ...
            //this.tbl_phieuthuephongTableAdapter.Fill(this.quanlykhachsanDataSet.tbl_phieuthuephong);
