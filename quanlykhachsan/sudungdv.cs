    ...
    public partial class sudungdv : Form
    {
        ...
        public void ketnoi()
        {
            try
            {
                if (cn.State == 0)
                {
                    cn.ConnectionString = @"Data Source=ADMINISTRATOR\SQLEXPRESS;Initial Catalog=quanlykhachsandemo2304;User ID=sa";
                    cn.Open();
                }
            }
            catch (Exception ex)
        ...
        private void ketnoi1()
        {
            try
            {
                SqlConnection kn1 = new SqlConnection(@"Data Source=ADMINISTRATOR\SQLEXPRESS;Initial Catalog=quanlykhachsandemo2304;User ID=sa");
                kn1.Open();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                SqlConnection kn = new SqlConnection(@"Data Source=ADMINISTRATOR\SQLEXPRESS;Initial Catalog=quanlykhachsandemo2304;User ID=sa");
                kn.Open();
